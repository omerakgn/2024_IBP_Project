...
<body>
  ...
  <label for="adminname">Mail Adresiniz</label>

  <asp:TextBox ID="txtadminmail" runat="server" TextMode="Email" CssClass="form-control"  placeholder="örn: omerfarukakgun22@gmail.com" AutoCompleteType="Disabled"></asp:TextBox>

</div>
<div class="form-group">
  <label for="adminpassword">Şifre</label>
  
  <asp:TextBox ID="txtadminpassword" runat="server" TextMode="Password" CssClass="form-control"  placeholder="Şifre"  ></asp:TextBox>
</div>


<asp:Button ID="btnadminlogin" CssClass="btn btn-dark" runat="server" Text="Giriş Yap" style="margin-top:20px;" OnClick="btnadminlogin_Click"></asp:Button>
