<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Doctoradd_dlt.aspx.cs" Inherits="Doctoradd_dlt" %>
         ...
         <div class="form-row">
            <div class="col-md-4 mb-3">
              <label for="validationCustom01">İsim</label>
                <asp:TextBox CssClass="form-control"  ID="txtdoctorname" runat="server" placeholder="First name"  AutoCompleteType="Disabled" ></asp:TextBox>
            ...
            <div class="col-md-4 mb-3">
              <label for="validationCustom02">Soyisim</label>
                 <asp:TextBox CssClass="form-control"  ID="txtdoctorsurname" runat="server" placeholder="Surname"  AutoCompleteType="Disabled" ></asp:TextBox>
              ...
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="inputGroupPrepend">@</span>
                   ...
                   <asp:TextBox CssClass="form-control"  ID="txtdoctormail" runat="server" TextMode="Email" placeholder="Mail"  AutoCompleteType="Disabled" aria-describedby="inputGroupPrepend" ></asp:TextBox>
          ...
          <div class="form-row">
            <div class="col-md-6 mb-3">
              <label for="validationCustom03">Şifre</label>
               <asp:TextBox CssClass="form-control"  ID="txtdoctorpassword" runat="server"  placeholder="Şifre"  AutoCompleteType="Disabled" aria-describedby="inputGroupPrepend" ></asp:TextBox>
